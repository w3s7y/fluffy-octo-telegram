...
class Surgery(models.Model):
    ...
    address = models.ForeignKey('Address', blank=False, null=False, on_delete=models.RESTRICT)
...
class Human(User):
    ...
    primary_contact_telephone = models.CharField(max_length=100, blank=False, null=False)
...
class Client(Human):
    registered_surgery = models.ForeignKey('Surgery', blank=False, on_delete=models.RESTRICT, null=False)
